...
echo " Building for Android and JVM..."
...
if [ -z "$NDK_HOME" ]; then
    echo "[WARNING]  NDK_HOME not set - skipping Android build"
    echo ""
    ...
    echo "[SUCCESS] NDK_HOME: $NDK_HOME"

    # Verify NDK toolchain exists
    TOOLCHAIN_DIR="$NDK_HOME/toolchains/llvm/prebuilt/$NDK_HOST"
    if [ ! -d "$TOOLCHAIN_DIR" ]; then
        echo "[WARNING]  NDK toolchain not found at: $TOOLCHAIN_DIR"
        echo "Skipping Android build"
    else
        echo "[SUCCESS] NDK toolchain verified"
...
if [ "$PLATFORM" = "Darwin" ]; then
    ...
    echo "[SUCCESS] macOS library built and copied"
    ...
    echo "[SUCCESS] Linux library built and copied"

else
    echo "[WARNING]  Unsupported platform for JVM: $PLATFORM"
fi
...
echo ""
echo "[SUCCESS] Kotlin build complete!"
echo ""
echo " Build Summary:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ -f "platforms/kotlin/src/commonMain/kotlin/uniffi/template/template.kt" ]; then
    echo "   [SUCCESS] Generated at: platforms/kotlin/src/commonMain/kotlin/uniffi/template/template.kt"
fi
